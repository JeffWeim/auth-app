...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/jeffreyaweimer/Projects/auth-app/src/components/Home.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	// 		<h1>Get an inspiring quote from yours truly!</h1>
	...
	exports.default = {
		...
		methods: {
			getQuote: function getQuote() {
				...
				this.$http.get('https://jw-auth-app.herokuapp.com/api/random-quote', function (data) {
					_this.quote = data;
				}).error(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/jeffreyaweimer/Projects/auth-app/src/components/App.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/jeffreyaweimer/Projects/auth-app/src/components/SecretQuote.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	    ...
	    methods: {
	        getQuote: function getQuote() {
	            ...
	            this.$http.get('https://jw-auth-app.herokuapp.com/api/protected/random-quote', function (data) {
	                _this.quote = data;
	            }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/jeffreyaweimer/Projects/auth-app/src/components/Signup.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/jeffreyaweimer/Projects/auth-app/src/components/Login.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var interceptor = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(22);
	var Promise = __webpack_require__(31);
	var xhrClient = __webpack_require__(33);
